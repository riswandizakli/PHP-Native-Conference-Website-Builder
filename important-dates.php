 ...
 if(isset($_POST['tambah'])){
   ...
   require_once("config.php");
       ...
       $for1 = $conf;
         ...
         $sql = "INSERT INTO important_dates (conf, activity, date)
    ...
    if($saved) {
         $message = 'Important Dates Berhasil Ditambahkan';

    echo "<SCRIPT> //not showing me this
        alert('$message')
        window.location.replace('important-dates.php');
    </SCRIPT>";
    }
		...
		<div class="main-panel">
					...
					<div class="col-md-4">
							<div class="card">
								<div class="card-header">
									<div class="card-title">Early Bird Registration Deadline </div>
								</div>
							<div class="card-body">
								<div class="row">
								...
								<div class="form-group">
								    <center>
											<img src="https://img.icons8.com/external-sbts2018-outline-sbts2018/58/000000/external-early-bird-cyber-monday-sbts2018-outline-sbts2018.png"><br/><br/>
													<?php 
										include 'koneksi.php';
										 $records = mysqli_query($db, "SELECT * FROM important_dates where conf ='$conf' and activity='1' ORDER BY id DESC");
           ...
           echo '<p><b>'.$abstract.'</b></p>';
										?>
													...
													<input name="for3" type="hidden" value="1">
												<input name="for2" type="date" class="form-control" id="email2" placeholder="put your topic here.">
										</center>
											</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Regular Registration </div>
								</div>
							<div class="card-body">
								<div class="row">
								    <div class="col-md-12 col-lg-12">
								...
								<div class="form-group">
								    <center>
							<img src="https://img.icons8.com/external-ddara-lineal-ddara/58/262626/external-registration-medical-ddara-lineal-ddara.png">
								<br/><br/>
								<?php 
										include 'koneksi.php';
										 $records = mysqli_query($db, "SELECT * FROM important_dates where conf ='$conf' and activity='2' ORDER BY id DESC");
          ...
          if(!empty($data)){
              echo '<p><b>'.$abstract.'</b></p>';
               ...
               echo '-';
								...
								<input name="for3" type="hidden" value="2">
												<input name="for2" type="date" class="form-control" id="email2" placeholder="put your topic here.">
										</center>
											</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Abstract Submission Deadline </div>
								</div>
							<div class="card-body">
								<div class="row">
								    <div class="col-md-12 col-lg-12">
								...
								<div class="form-group">
								    <center>
										<img src="https://img.icons8.com/ios/58/262626/submit-document.png"><br/><br/>
											<?php 
										include 'koneksi.php';
										 $records = mysqli_query($db, "SELECT * FROM important_dates where conf ='$conf' and activity='3' ORDER BY id DESC");
          ...
          if(!empty($data)){
              echo '<p><b>'.$abstract.'</b></p>';
               ...
               echo '<p>-</p>';
										...
										?>
											<input name="for3" type="hidden" value="3">
												<input name="for2" type="date" class="form-control" id="email2" placeholder="put your topic here.">
										</center>
											</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Notification of Acceptance (Max) </div>
								</div>
							<div class="card-body">
								<div class="row">
								    <div class="col-md-12 col-lg-12">
								...
								<div class="form-group">
								    <center>
										<img src="https://img.icons8.com/external-sbts2018-outline-sbts2018/58/262626/external-notification-social-media-basic-1-sbts2018-outline-sbts2018.png"><br/><br/>
												<?php 
										include 'koneksi.php';
										 $records = mysqli_query($db, "SELECT * FROM important_dates where conf ='$conf' and activity='4' ORDER BY id DESC");
          ...
          if(!empty($data)){
              echo '<p><b>'.$abstract.'</b></p>';
               ...
               echo '<p>-</p>';
										...
										?>
												<input name="for3" type="hidden" value="4">
												<input name="for2" type="date" class="form-control" id="email2" placeholder="put your topic here.">
										</center>
											</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Payment for Registration Deadline </div>
								</div>
							<div class="card-body">
								<div class="row">
								    <div class="col-md-12 col-lg-12">
								...
								<div class="form-group">
								    <center>
										<img src="https://img.icons8.com/ios-glyphs/58/null/pay.png"/><br/><br/>
										<?php 
										include 'koneksi.php';
										 $records = mysqli_query($db, "SELECT * FROM important_dates where conf ='$conf' and activity='5' ORDER BY id DESC");
          ...
          if(!empty($data)){
              echo '<p><b>'.$abstract.'</b></p>';
               ...
               echo '<p>-</p>';
										...
										?>
											<input name="for3" type="hidden" value="5">
												<input name="for2" type="date" class="form-control" id="email2" placeholder="put your topic here.">
										</center>
											</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Fullpaper Submission </div>
								</div>
							<div class="card-body">
								<div class="row">
								    <div class="col-md-12 col-lg-12">
								...
								<div class="form-group">
								    <center>
										<img src="https://img.icons8.com/dotty/58/262626/submit-document.png"><br/><br/>
										<?php 
										include 'koneksi.php';
										 $records = mysqli_query($db, "SELECT * FROM important_dates where conf ='$conf' and activity='6' ORDER BY id DESC");
          ...
          if(!empty($data)){
              echo '<p><b>'.$abstract.'</b></p>';
               ...
               echo '<p>-</p>';
										...
										?>
											<input name="for3" type="hidden" value="6">
												<input name="for2" type="date" class="form-control" id="email2" placeholder="put your topic here.">
										</center>
											</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Conference Date </div>
								</div>
							<div class="card-body">
								<div class="row">
								    <div class="col-md-12 col-lg-12">
								...
								<div class="form-group">
								    <center>
										<img src="https://img.icons8.com/external-kiranshastry-lineal-kiranshastry/64/262626/external-conference-communication-kiranshastry-lineal-kiranshastry-4.png"><br/><br/>
													<input name="for3" type="hidden" value="7">
													<?php 
										include 'koneksi.php';
										 $records = mysqli_query($db, "SELECT * FROM important_dates where conf ='$conf' and activity='7' ORDER BY id DESC");
