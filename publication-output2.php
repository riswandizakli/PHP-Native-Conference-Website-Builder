 ...
 if(isset($_POST['tambah'])){
   require_once("config.php");
       ...
       $for1 = $conf;
         ...
         $sql = "INSERT INTO publication (conf, publication)
            VALUES (:satu, :dua)";
    $stmt = $db->prepare($sql);
    ...
    if($saved) {
         $message = 'Publication output berhasil ditambahkan';
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="multi-filter-select" class="display table table-striped table-hover" >
                                            ...
                                            $records = mysqli_query($db, "SELECT * FROM publication where conf ='$conf'");
      $count = 1;
            while ($data = mysqli_fetch_array($records)) : ?>
							...
							<div class="card-body">
								...
								<div class="form-group">
												...
												<input name="for2" type="text" class="form-control" id="email2" placeholder="put your Publication Output here.">
