				...
				<div class="page-inner">
					...
					<div class="row">
						...
						<div class="col-md-9">
						    	...
						    	<div class="col-md-3">
						    	    	<a href="export-excel-pemilik.php" class="btn btn-secondary btn-round"><b>></b> Export Data Ke Excel</a>
						    </div>
            ...
            while ($data = mysqli_fetch_array($records)) : ?>
												<tr>
													...
													<td><?php echo $data['alamat_domisili']; ?></td>
													 ...
													 <form class ="btn btn-xs" method="post" action="admin-edit-pemilik.php">
