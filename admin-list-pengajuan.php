			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Data List Pengajuan Akun Pemilik Tanah</h4>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
								    	<div class="row mt--2">
						<div class="col-md-9">
						    	<h4 class="card-title">Data Pengajuan Akun Pemilik Tanah Ciseeng</h4><br/>
						    </div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="multi-filter-select" class="display table table-striped table-hover" >
                                            ...
                                            $records = mysqli_query($db, "SELECT * FROM pemilik_tanah where status_akun ='0'");
      $count = 1;
            while ($data = mysqli_fetch_array($records)) : ?>
												<tr>
													...
													<td><?php echo $data['alamat_domisili']; ?></td>
													 ...
													 <form class="form-login" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Apakah anda yakin untuk mengaktifkan akun ini?');" > 
                                                      <input type="hidden" name="aidi" value="<?php echo $data['id'];?>">
															<button type="submit" name="header" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Aktifkan Akun">
																<i class="fa fa-check"></i>
															</button>
															</form>
															
															 <form class="form-login" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Apakah anda yakin untuk menghapus akun ini?');" > 
															  <input type="hidden" name="aidi" value="<?php echo $data['id'];?>">
