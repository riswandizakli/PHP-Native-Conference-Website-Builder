...
function uploadProfile($leadid)
{
    ...
    $namaStmtFileBaru = $leadid.'_template';//uniqid();
    $namaStmtFileBaru .= '.';
...
$ekstensi_diperbolehkan	= array('doc','docx','pdf');
    ...
    move_uploaded_file($tmpStmtName, 'template/' . $namaStmtFileBaru);
			}
 ...
 if(isset($_POST['tambah'])){
   require_once("config.php");
       ...
       $for1 = $conf;
       $asde = filter_input(INPUT_POST, 'asde', FILTER_SANITIZE_STRING);
       
            $profpic = uploadProfile($for1."_".$asde);
                                    ...
                                    $for2 = $profpic;
                                        ...
                                        include "koneksi.php";
                                           ...
                                           include "config.php";
        if ($asde == 'abstract'){
              $sql = "UPDATE template set abstract=:dua where conf=:satu";
        }
          if ($asde == 'paper'){
              $sql = "UPDATE template set paper=:dua where conf=:satu";
        }
    ...
    if($saved) {
         $message = 'Update File Berhasil Dilakukan';

    echo "<SCRIPT> //not showing me this
        alert('$message')
        window.location.replace('file-template.php');
    </SCRIPT>";
    }
				...
				<div class="sidebar-content">
					...
					<img src="https://img.icons8.com/wired/30/null/task--v3.png"/>
						...
						<li class="nav-item">
							...
							<div class="collapse show" id="sidebarLayouts2">
							<ul class="nav nav-collapse">
									<li>
					...
					<div class="col-md-5">
							<div class="card">
								<div class="card-header">
								     <center>
									<div class="card-title">Abstract Template </div>
									 </center>
								</div>
							<div class="card-body">
								<div class="row">
								...
								<div class="form-group">
								    <center>
										<img src="https://img.icons8.com/ios/80/262626/submit-document.png"><Br/>
										
										<?php 
										include 'koneksi.php';
										 $records = mysqli_query($db, "SELECT * FROM template where conf ='$conf'");
     
           $data = mysqli_fetch_array($records);
           $abstract = $data['abstract'];
           $paper = $data['paper'];
										?>
										<a style="color:white;" href="template/<?php echo $abstract;?>" class="btn btn-success">View Template</a>
										<br/><br/><br/>
											<p>Upload Files Here:</p>
											<input name="asde" type="hidden" value="abstract">
													<input accept=".doc, .docx, .pdf" name="for5" type="file" class="form-control" id="email2" placeholder="put your topic here.">
										</center>
											</div>
							...
							<div class="card">
								<div class="card-header">
								    <center>
									<div class="card-title">Fullpaper Template </div>
									</center>
								</div>
							<div class="card-body">
								<div class="row">
								...
								<div class="form-group">
								    <center>
						<img src="https://img.icons8.com/dotty/80/262626/submit-document.png"><br/>
																<a style="color:white;" href="template/<?php echo $paper;?>" class="btn btn-success">View Template</a>

						<br/>	<br/>	<br/>
								<p>Upload Files Here:</p>
									<input name="asde" type="hidden" value="paper">
												<input accept=".doc, .docx, .pdf" name="for5" type="file" class="form-control" id="email2" placeholder="put your topic here.">
										</center>
											</div>
