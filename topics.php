 ...
 if(isset($_POST['tambah'])){
   ...
   require_once("config.php");
       ...
       $for1 = $conf;
         ...
         $sql = "INSERT INTO topics (conf, topic, pos)
    ...
    echo "<SCRIPT> //not showing me this
        alert('$message')
        window.location.replace('topics.php');
    </SCRIPT>";
    }
					...
					<div class="row">
						<div class="col-md-12">
								...
								<div class="card-header">
								    	<div class="row mt--2">
						<div class="col-md-9">
						    	<h4 class="card-title">List Topics</h4><br/>
						    </div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="multi-filter-select" class="display table table-striped table-hover" >
                                            ...
                                            $records = mysqli_query($db, "SELECT * FROM topics where conf ='$conf' order by pos");
                                            
                                             $records2 = mysqli_query($db, "SELECT * FROM topics where conf ='$conf' order by pos LIMIT 1000 OFFSET 1 ");
                                             
                                              $records3 = mysqli_query($db, "SELECT * FROM topics where conf ='$conf' order by pos desc");
      ...
      $cate = $cataz['pos'];
            ...
            ?>
												<tr>
													...
													<td>
													   <form action="deletebyid.php" method="POST" class="form-horizontal" enctype="multipart/form-data" onsubmit="return confirm('Do you really want to delete the topic?');" style-form>
													        <input type="hidden" name="aidi" value="<?php echo $data['id']; ?>">
													         <input type="hidden" name="cate" value="topics">
													    <button type="submit" name="remove" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
																...
																<td>
													   <form action="uprankbyid.php" method="POST" class="form-horizontal" enctype="multipart/form-data" onsubmit="return confirm('Do you really want to delete the topic?');" style-form>
													         <input type="hidden" name="cate" value="topics">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Tambah Topik Conference  </div>
								</div>
							<div class="card-body">
								<div class="row">
								...
								<div class="form-group">
												<label for="email2">Tambah Topics
</label>
												<input name="for2" type="text" class="form-control" id="email2" placeholder="put your topic here.">
