 ...
 if(isset($_POST['tambah'])){
   ...
   require_once("config.php");
       ...
       $for1 = $conf;
         ...
         $sql = "INSERT INTO publication (conf, publication, pos)
    ...
    echo "<SCRIPT> //not showing me this
        alert('$message')
        window.location.replace('publication-output.php');
    </SCRIPT>";
    }
				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Conference Publication Output</a>
							</li>
					...
					<div class="row">
						<div class="col-md-12">
								...
								<div class="card-header">
								    	<div class="row mt--2">
						<div class="col-md-9">
						    	<h4 class="card-title">List Publication Output</h4><br/>
						    </div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="multi-filter-select" class="display table table-striped table-hover" >
                                            ...
                                            $records = mysqli_query($db, "SELECT * FROM publication where conf ='$conf' order by pos");
                                            
                                             $records2 = mysqli_query($db, "SELECT * FROM publication where conf ='$conf' order by pos LIMIT 1000 OFFSET 1 ");
                                             
                                              $records3 = mysqli_query($db, "SELECT * FROM publication where conf ='$conf' order by pos desc");
      ...
      $cate = $cataz['pos'];
            ...
            ?>
												<tr>
													...
													<td><?php echo $data['conf']; ?></td>
													<td><?php echo $data['publication']; ?></td>
													<td>
													   <form action="deletebyid.php" method="POST" class="form-horizontal" enctype="multipart/form-data" onsubmit="return confirm('Do you really want to delete the publication?');" style-form>
													        <input type="hidden" name="aidi" value="<?php echo $data['id']; ?>">
													         <input type="hidden" name="cate" value="publication-output">
													   ...
													   <form action="uprankbyid.php" method="POST" class="form-horizontal" enctype="multipart/form-data" onsubmit="return confirm('Make this item lower?');" style-form>
													         <input type="hidden" name="cate" value="publication">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Tambah Publication Output Conference  </div>
								</div>
							<div class="card-body">
								<div class="row">
								...
								<div class="form-group">
												<label for="email2">Tambah Publication Output
</label>
												<input name="for2" type="text" class="form-control" id="email2" placeholder="put your Publication Output.">
