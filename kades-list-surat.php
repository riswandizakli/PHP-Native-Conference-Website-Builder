			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Data List Surat Tanah</h4>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
								    	<div class="row mt--2">
						<div class="col-md-9">
						    	<h4 class="card-title">Data Surat Tanah Ciseeng</h4><br/>
						    </div>
            ...
            while ($data = mysqli_fetch_array($records)) : ?>
												<tr>
													...
													<td><?php echo $data['alamat_domisili']; ?></td>
														...
														<td><button onclick="document.getElementById('<?php echo $data['id'];?>').style.display='block'" class="btn btn-success">Buka Surat Tanah</button></td>
  ...
  <div id="<?php echo $data['id'];?>" class="w3-modal">
    <div class="w3-modal-content">
      <div class="w3-container">
        ...
        <center><h1><b>Surat Tanah </b></h1></center>
        <br/>
          <h3>Nama Pemilik Tanah : <b><?php echo $data['nama_lengkap'];?></b></h3>
           
          <br/>
           <embed type="application/pdf" src="surat_tanah/<?php echo $data['surat_tanah']; ?>" width="100%" height="700"></embed>
