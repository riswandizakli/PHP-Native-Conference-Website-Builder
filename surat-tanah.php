					...
					<!--
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="assetsdash/img/profile.jpg" alt="..." class="avatar-img rounded-circle">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="assetsdash/img/profile.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Fahman</h4>
												<p class="text-muted">Fahman@yahoo.com</p><a href="profile.html" class="btn btn-xs btn-secondary btn-sm">View Profile</a>
											</div>
										</div>
									</li>
									<li>
										...
										<a class="dropdown-item" href="#">Informasi Pertanahan</a>
										<a class="dropdown-item" href="#">Pengajuan Transaksi</a>
										<div class="dropdown-divider"></div>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Dashboard Sistem Pertanahan</h2>
								<h5 class="text-white op-7 mb-2"></h5>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
							
								<a href="#" class="btn btn-secondary btn-round">Edit Surat Tanah</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row mt--2">
						<div class="col-md-12">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">Informasi Surat Tanah Anda</div>
							...
							<div class="col-md-12">
							<div class="card full-height">
						<embed type="application/pdf" src="surat_tanah/<?php echo $surat;?>" width="100%" height="700"></embed>
							</div>
						</div>
					</div>
