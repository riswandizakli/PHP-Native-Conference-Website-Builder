				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Dashboard Admin Sistem Pertanahan</h2>
								<h5 class="text-white op-7 mb-2"></h5>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
								<a href="admin-list-bidang.php" class="btn btn-white btn-border btn-round mr-2">Bidang Tanah </a>
								<a href="admin-list-transaksi.php" class="btn btn-secondary btn-round">List Transaksi</a>
							</div>
						</div>
					</div>
				</div>
