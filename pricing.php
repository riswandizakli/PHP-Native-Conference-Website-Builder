 ...
 if(isset($_POST['tambah'])){
       ...
       $for1 = $conf;
             $for2 = filter_input(INPUT_POST, 'category', FILTER_SANITIZE_STRING);
               $for3 = filter_input(INPUT_POST, 'early', FILTER_SANITIZE_STRING);
               $for4 = filter_input(INPUT_POST, 'price', FILTER_SANITIZE_STRING);
                   $fo5 = $for4/1000;
                    $fo6 = $for4/10000;
         ...
         $sql = "INSERT INTO price (conf, category, early, price, text, textusd)
    ...
    if($saved) {
         $message = 'Penambahan price conferences berhasil.';
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Conference Price</h4>
					...
					<div class="row">
						<div class="col-md-12">
								...
								<div class="card-header">
								    	<div class="row mt--2">
						<div class="col-md-9">
						    	<h4 class="card-title">List Price</h4><br/>
						    </div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="multi-filter-select" class="display table table-striped table-hover" >
                                            ...
                                            $records = mysqli_query($db, "SELECT * FROM price where conf ='$conf'");
      $count = 1;
            while ($data = mysqli_fetch_array($records)) : ?>
													...
													<td>
													   <form action="deletebyid.php" method="POST" class="form-horizontal" enctype="multipart/form-data" onsubmit="return confirm('Apakah anda yakin ingin menghapus ini?');" style-form>
													        <input type="hidden" name="aidi" value="<?php echo $data['id']; ?>">
													         <input type="hidden" name="cate" value="pricing">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Tambah Conference Price  </div>
								</div>
							<div class="card-body">
								<div class="row">
								...
								<div class="form-group">
												...
												<input name="category" type="text" class="form-control" id="email2" placeholder="Oral Presenter (Non-Student)">
								...
								<div class="form-group">
												<label for="email2">Early Bird/Regular
</label>
<select name="early" class="form-control">
    <option>Regular</option>
     <option>Early</option>
								...
								<div class="form-group">
												<label for="email2">Price (number only)
</label>
												<input name="price" type="number" min="0" class="form-control" id="email2" placeholder="100000">
											<!--	<small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
											</div>
