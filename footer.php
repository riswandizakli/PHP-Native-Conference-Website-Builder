...
function uploadProfile($leadid)
{
    ...
    $namaStmtFileBaru = $leadid.$namaStmtFile.$ukuranStmtFile.'_speakers';//uniqid();
    $namaStmtFileBaru .= '.';
...
$ekstensi_diperbolehkan	= array('png','jpg','jpeg');
    ...
    move_uploaded_file($tmpStmtName, 'logofooter/' . $namaStmtFileBaru);
			}
 ...
 if(isset($_POST['tambah'])){
       ...
       $for1 = $conf;
             $for2 = filter_input(INPUT_POST, 'category', FILTER_SANITIZE_STRING);
             $for4 = filter_input(INPUT_POST, 'for4', FILTER_SANITIZE_STRING);
              $for4 = $for4+1;
                   
                     $profpic = uploadProfile($for1.$for2);
                   
                                        include "koneksi.php";
                                          
                                           include "config.php";
        
         $sql = "INSERT INTO footer (conf, tipe, images, pos)
    ...
    if($saved) {
         $message = 'Penambahan footer logo berhasil.';
...
<body>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Conference Footer</h4>
					...
					<div class="row">
						<div class="col-md-12">
								...
								<div class="card-header">
								    	<div class="row mt--2">
						<div class="col-md-9">
						    	<h4 class="card-title">List Logo Footer</h4><br/>
						    </div>
								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="multi-filter-select" class="display table table-striped table-hover" >
                                            ...
                                            $records = mysqli_query($db, "SELECT * FROM footer where conf ='$conf' order by pos");
      $records2 = mysqli_query($db, "SELECT * FROM footer where conf ='$conf' order by pos LIMIT 1000 OFFSET 1 ");
                                              $records3 = mysqli_query($db, "SELECT * FROM footer where conf ='$conf' order by pos desc");
            ...
            $data2 = mysqli_fetch_array($records2); ?>
												<tr>
													...
													<td><?php echo $data['conf']; ?></td>
														...
														<td><img src="logofooter/<?php echo $data['images']; ?>" alt="" height="200">
</td>
	...
	<td>
													   <form action="uprankbyid.php" method="POST" class="form-horizontal" enctype="multipart/form-data" onsubmit="return confirm('Make this item lower?');" style-form>
													         <input type="hidden" name="cate" value="footer">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">Tambah Logo Footer  </div>
								</div>
							<div class="card-body">
								<div class="row">
...
<select name="category" class="form-control">
	...
	<input name="for3" type="hidden" class="form-control" value="<?php echo $cate;?>">
								...
								<div class="form-group">
												<label for="email2">Image Logo 
</label>
												<input name="for5" type="file" min="0" accept=".jpg, .png, .jpeg" class="form-control" id="email2" >
											<!--	<small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
											</div>
