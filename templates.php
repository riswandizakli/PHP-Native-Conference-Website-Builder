 ...
 if(isset($_POST['tambah'])){
   require_once("config.php");
       ...
       $for1 = $conf;
        ...
        $sql = "UPDATE conference_detail set template=:dua where conf=:satu";
    ...
    if($saved) {
         $message = 'Perubahan Templates Behrasil Dilakukan';
...
<body>
	...
	<div class="main-header">
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Website Templates</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Choose your website style</a>
							</li>
					...
					<div class="col-md-5">
							<div class="card">
								<div class="card-header">
								     <center>
									<div class="card-title">Template 1 <br/>
									(Pro-Conferences)
									</div>
									 </center>
								</div>
							<div class="card-body">
								...
								<div class="form-group">
								    <center>
										<img src="components/template1.PNG" height="100"><br/><br/>
											<p>Details: <br/>
								
								</p>
							
								    <li>More Light</li>
							  <li>Yellow Mix With Blue</li>
										</center>
											</div>
		...
		<input type="hidden" name="for2" value="1"/>
								...
								<div class="card-action">
								    <center>
									<button type="submit" name="tambah" class="btn btn-success">Change Templates</button>
									</center>
									</form>
	...
	<!--							<div class="card-header">-->
	<!--							    <center>-->
	<!--								<div class="card-title">Template 2 <br/>-->
	<!--									(E-Conferences)-->
	<!--								</div>-->
	<!--								</center>-->
	<!--							</div>-->
	...
	<!--							<div class="form-group">-->
	<!--							    <center>-->
	<!--				<img src="components/template2.PNG" height="100"><br/><br/>-->
	<!--							<p>Details: <br/>-->
								
	<!--							</p>-->
							
	<!--							    <li>More Darker</li>-->
	<!--						  <li>Dark Blue Mix With Blue</li>-->
	...
	<!--<input type="hidden" name="for2" value="2"/>-->
