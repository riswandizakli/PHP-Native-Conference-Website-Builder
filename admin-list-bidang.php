					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							...
							<div class="ml-md-auto py-2 py-md-0">
								...
								<a href="full-tanah.php" class="btn btn-secondary btn-round">Informasi Bidang Tanah Lengkap</a>
							</div>
						</div>
					</div>
				</div>
												   ...
												   <option disabled selected> -- Pilih Bidang -- </option>
													...
													<option value="pbt5875">PBT 5875</option>
														<option value="pbt5478">PBT 5478</option>
															...
															<option value="pbt5481">PBT 5481</option>
															<option value="pbt2799">PBT 2799</option>
															<option value="pbt5480">PBT 5480</option>
