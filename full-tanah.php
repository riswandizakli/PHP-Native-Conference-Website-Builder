			...
			<div class="content">
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white pb-2 fw-bold">Informasi Bidang Tanah Lengkap</h2>
								<h5 class="text-white op-7 mb-2"></h5>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
							
								<a href="admin-list-bidang.php" class="btn btn-secondary btn-round">Cari Bidang Tanah</a>
							</div>
						</div>
					</div>
				</div>
				<div class="page-inner mt--5">
					<div class="row mt--2">
						...
						<iframe height="700px" width="100%;" src="//\sharecad.org/cadframe/load?url=https://pertanahan.sicenting.id/databasemaps/CiseengFull.dwg" scrolling="no"> </iframe>
							</div>
						</div>
					</div>
